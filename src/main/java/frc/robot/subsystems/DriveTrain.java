...
public class DriveTrain extends Subsystem implements LoggableSubsystem {
    ...
    // TODO find out about encoders for spark motor controller
    // creates motors
    ...
    private boolean skidSteer = false;
    ...
    private DriveTrain() {
        ...
        // mecanum
        /*
        SpeedControllerGroup left1 = new SpeedControllerGroup(motorLeft1);//left
        front SpeedControllerGroup left2 = new
                SpeedControllerGroup(motorLeft2);//left back SpeedControllerGroup right1 =
        new SpeedControllerGroup(motorRight1);//right front SpeedControllerGroup
        right2 = new SpeedControllerGroup(motorRight2);//right back
        
        //TankDrive and arcade drive SpeedControllerGroup leftGroup = new
        SpeedControllerGroup(motorLeft1,motorLeft2);//left front SpeedControllerGroup
        rightGroup = new SpeedControllerGroup(motorRight1,motorRight2);//left back
        */
    ...
    */
     ...
     * @param lb
     *            the left back
     * @param skidSteerDrive
     *            true = in skid steer false = not in skid steer
     */
    ...
    public void log() {
        ...
        SmartDashboard.putNumber("joystick x", Robot.oi.getDriveOperator().getDriveSideway());
        SmartDashboard.putNumber("joystick y", Robot.oi.getDriveOperator().getDriveForward());
    }
